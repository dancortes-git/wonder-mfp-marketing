...
This project is a Micro Frontend build with React SPA and Webpack Module Federation. It is used to build the Landing and Pricing page of the application.
